...
def test_records_all(client):
    ...
    # League + 4 teams
    r = client.post("/leagues/", json={"name": "RecordsLeague", "roster_slots": 14, "starters": 8, "bucket_requirements": {"X": 8}})
    ...
    for key in ["team_week_high", "game_total_high", "blowout_high", "narrowest_win", "longest_win_streak", "longest_unbeaten_streak"]:
        assert key in data
