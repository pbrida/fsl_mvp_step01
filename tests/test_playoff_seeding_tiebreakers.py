...
def test_playoff_seeding_follows_tiebreakers(client):
    ...
    # League + 4 teams
    r = client.post("/leagues/", json={"name": "SeedTB League", "roster_slots": 14, "starters": 8, "bucket_requirements": {"X": 8}})
    ...
    bracket_order = [semis[0]["home_team_id"], semis[1]["home_team_id"], semis[1]["away_team_id"], semis[0]["away_team_id"]]
