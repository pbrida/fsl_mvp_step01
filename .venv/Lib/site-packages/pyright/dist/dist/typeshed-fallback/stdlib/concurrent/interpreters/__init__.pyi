...
if sys.version_info >= (3, 13):  # needed to satisfy pyright checks for Python <3.13
    ...
    from ._queues import Queue as Queue
    from ._queues import QueueEmpty as QueueEmpty
    from ._queues import QueueFull as QueueFull
    from ._queues import create as create_queue
    ...
    class Interpreter:
        ...
        def whence(
            ...
            "unknown", "runtime init", "legacy C-API", "C-API", "cross-interpreter C-API", "_interpreters module"
        ]: ...
