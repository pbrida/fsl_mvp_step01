...
@overload
def find(
    domain: str, localedir: StrPath | None = None, languages: Iterable[str] | None = None, all: bool = False
) -> Any: ...
...
if sys.version_info >= (3, 11):
    ...
    def install(
        domain: str, localedir: StrPath | None, codeset: str, /, names: Container[str] | None = None
    ) -> None: ...
    @overload
    @deprecated("The `codeset` parameter is deprecated since Python 3.8; removed in Python 3.11.")
    def install(
        domain: str, localedir: StrPath | None = None, *, codeset: str, names: Container[str] | None = None
    ) -> None: ...
