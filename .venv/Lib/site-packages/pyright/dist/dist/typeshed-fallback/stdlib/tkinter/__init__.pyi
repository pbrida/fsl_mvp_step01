...
class Variable:
    ...
    def get(self): ...
    def trace_add(
        self, mode: Literal["array", "read", "write", "unset"], callback: Callable[[str, str, str], object]
    ) -> str: ...
...
class Misc:
    ...
    def option_add(
        ...
        pattern,
        value,
        priority: int | Literal["widgetDefault", "startupFile", "userDefault", "interactive"] | None = None,
    ) -> None: ...
    ...
    @overload
    def bind_class(
        self, className: str, sequence: str | None, func: str, add: Literal["", "+"] | bool | None = None
    ) -> None: ...
    @overload
...
def Tcl(
    screenName: str | None = None, baseName: str | None = None, className: str = "Tk", useTk: bool = False
) -> Tk: ...
...
class Text(Widget, XView, YView):
    ...
    if sys.version_info >= (3, 13):
        ...
        @overload
        def count(
            self, index1: _TextIndex, index2: _TextIndex, arg1: Literal["update"], arg2: _WhatToCount, /
        ) -> int | None: ...
        @overload
        def count(
            self, index1: _TextIndex, index2: _TextIndex, arg1: _WhatToCount, arg2: Literal["update"], /
        ) -> int | None: ...
        @overload
        def count(
    ...
    def replace(
        self, index1: _TextIndex, index2: _TextIndex, chars: str, *args: str | list[str] | tuple[str, ...]
    ) -> None: ...
    ...
    @overload
    def tag_bind(
        self, tagName: str, sequence: str | None, func: str, add: Literal["", "+"] | bool | None = None
    ) -> None: ...
