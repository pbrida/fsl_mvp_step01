...
class Convertible(Typed[_T, _N]):
    ...
    @overload
    def __set__(
        self: Convertible[int, Literal[False]], instance: Serialisable | Strict, value: ConvertibleToInt
    ) -> None: ...
    # float
    @overload
    def __set__(
    ...
    @overload
    def __set__(
        self: Convertible[float, Literal[False]], instance: Serialisable | Strict, value: ConvertibleToFloat
    ) -> None: ...
    # Anything else
    @overload
    def __set__(
        self: Convertible[_T, Literal[True]], instance: Serialisable | Strict, value: _T | int | Any | None
    ) -> None: ...
...
class Max(Convertible[_M, _N]):
    ...
    def __set__(
        self: Max[int, Literal[True]], instance: Serialisable | Strict, value: ConvertibleToInt | None
    ) -> None: ...
    @overload
    def __set__(self: Max[int, Literal[False]], instance: Serialisable | Strict, value: ConvertibleToInt) -> None: ...
    @overload
    def __set__(
        self: Max[float, Literal[True]], instance: Serialisable | Strict, value: ConvertibleToFloat | None
    ) -> None: ...
    @overload
    def __set__(
...
class Min(Convertible[_M, _N]):
    ...
    @overload  # type: ignore[override]  # Different restrictions
    def __set__(
        self: Min[int, Literal[True]], instance: Serialisable | Strict, value: ConvertibleToInt | None
    ) -> None: ...
    @overload
    def __set__(self: Min[int, Literal[False]], instance: Serialisable | Strict, value: ConvertibleToInt) -> None: ...
    @overload
    def __set__(
        self: Min[float, Literal[True]], instance: Serialisable | Strict, value: ConvertibleToFloat | None
    ) -> None: ...
    @overload
    def __set__(
...
class Integer(Convertible[int, _N]):
    ...
    @overload
    def __init__(
        self: Integer[Literal[False]], name: str | None = None, *, allow_none: Literal[False] = False
    ) -> None: ...
...
class MatchPattern(Descriptor[_P], Generic[_P, _N]):
    ...
    @overload
    def __get__(
        self: MatchPattern[_P, Literal[True]], instance: Serialisable | Strict, cls: type | None = None
    ) -> _P | None: ...
    @overload
    def __get__(
        self: MatchPattern[_P, Literal[False]], instance: Serialisable | Strict, cls: type | None = None
    ) -> _P: ...
    @overload
...
class DateTime(Typed[datetime, _N]):
    ...
    @overload
    def __init__(
        self: DateTime[Literal[False]], name: str | None = None, *, allow_none: Literal[False] = False
    ) -> None: ...
    @overload
    def __set__(
