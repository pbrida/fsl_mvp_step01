...
from twisted.internet.interfaces import (
    ITransport,  # type: ignore[import-not-found]  # pyright: ignore[reportMissingImports]
)
from twisted.internet.protocol import (
    Protocol,  # type: ignore[import-not-found]  # pyright: ignore[reportMissingImports]
)
...
class _TwistedConnectionAdapter(pika.connection.Connection):
    def __init__(
        self, parameters, on_open_callback, on_open_error_callback, on_close_callback, custom_reactor
    ) -> None: ...
