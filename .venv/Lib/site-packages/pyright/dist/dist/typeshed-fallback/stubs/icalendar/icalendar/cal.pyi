...
class Event(Component):
    ...
    def rdates(
        ...
        tuple[datetime.date, None] | tuple[datetime.datetime, None] | tuple[datetime.datetime, datetime.datetime]
    ]: ...
    @property
...
class Timezone(Component):
    ...
    def get_transitions(
        self,
    ) -> tuple[list[datetime.datetime], list[tuple[datetime.timedelta, datetime.timedelta, str]]]: ...
    @classmethod
    def from_tzinfo(
        cls,
    ...
    @classmethod
    def from_tzid(
        cls, tzid: str, tzp: TZP = ..., first_date: datetime.date = ..., last_date: datetime.date = ...
    ) -> Self: ...
    @property
