...
class DamageBonus(google.protobuf.message.Message):
    ...
    def __init__(
        self, *, attribute: global___Attribute.ValueType | None = ..., bonus: builtins.float | None = ...
    ) -> None: ...
...
class Weapon(google.protobuf.message.Message):
    ...
    def damage_bonus(
        self,
    ) -> google.protobuf.internal.containers.RepeatedCompositeFieldContainer[global___DamageBonus]: ...
    def __init__(
        self,
        *,
...
class UnitTypeData(google.protobuf.message.Message):
    ...
    def attributes(
        self,
    ) -> google.protobuf.internal.containers.RepeatedScalarFieldContainer[global___Attribute.ValueType]:
