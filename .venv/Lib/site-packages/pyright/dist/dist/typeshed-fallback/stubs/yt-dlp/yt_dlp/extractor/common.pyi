...
from ..utils._utils import RetryManager as _RetryManager
...
class InfoExtractor:
    ...
    def _configuration_arg(
        self, key: str, default: Any = ..., *, ie_key: str | None = ..., casesense: bool = ...
    ) -> Any: ...
    ...
    def _og_search_title(
        self, html: str, *, fatal: bool = False, default: type[NO_DEFAULT] | str = ...
    ) -> str | None: ...
    ...
    def _og_search_url(
        self, html: str, *, default: type[NO_DEFAULT] | str = ..., fatal: bool = False
    ) -> str | None: ...
    ...
    def RetryManager(
        self, *, _retries: int | None, _error_callback: Callable[..., Any], **kwargs: Any
    ) -> _RetryManager: ...
    @classmethod
    ...
    def _error_or_warning(
        self, err: str, _count: int | None = None, _retries: int = 0, *, fatal: bool = True
    ) -> None: ...
