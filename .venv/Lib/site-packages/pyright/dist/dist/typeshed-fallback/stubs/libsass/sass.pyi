...
_CustomFunctions: TypeAlias = (
    Mapping[str, Callable[..., Any]] | Sequence[Callable[..., Any]] | AbstractSet[Callable[..., Any]]
)
...
class SassColor(_SassColor):
    def __new__(
        cls, r: ConvertibleToFloat, g: ConvertibleToFloat, b: ConvertibleToFloat, a: ConvertibleToFloat
    ) -> Self: ...
