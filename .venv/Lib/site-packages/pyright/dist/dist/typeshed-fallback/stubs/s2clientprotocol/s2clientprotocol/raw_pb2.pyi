...
class RadarRing(google.protobuf.message.Message):
    ...
    def __init__(
        self, *, pos: s2clientprotocol.common_pb2.Point | None = ..., radius: builtins.float | None = ...
    ) -> None: ...
...
class PlayerRaw(google.protobuf.message.Message):
    ...
    def power_sources(
        self,
    ) -> google.protobuf.internal.containers.RepeatedCompositeFieldContainer[global___PowerSource]: ...
    @property
...
class RallyTarget(google.protobuf.message.Message):
    ...
    def __init__(
        self, *, point: s2clientprotocol.common_pb2.Point | None = ..., tag: builtins.int | None = ...
    ) -> None: ...
...
class Unit(google.protobuf.message.Message):
    ...
    def passengers(
        self,
    ) -> google.protobuf.internal.containers.RepeatedCompositeFieldContainer[global___PassengerUnit]: ...
    @property
    def rally_targets(
        self,
    ) -> google.protobuf.internal.containers.RepeatedCompositeFieldContainer[global___RallyTarget]: ...
    def __init__(
        self,
        *,
...
class Effect(google.protobuf.message.Message):
    ...
    def HasField(
        self,
        field_name: typing.Literal[
            "alliance", b"alliance", "effect_id", b"effect_id", "owner", b"owner", "radius", b"radius"
        ],
    ) -> builtins.bool: ...
    def ClearField(
        self,
