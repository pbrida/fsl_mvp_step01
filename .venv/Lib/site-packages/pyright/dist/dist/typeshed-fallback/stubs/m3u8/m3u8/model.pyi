...
class Segment(BasePathMixin):
    ...
    def dumps(
        self, last_segment: PartialSegment | None, timespec: str = "milliseconds", infspec: str = "auto"
    ) -> str: ...
    @property
    def base_path(self) -> str: ...
    @base_path.setter
...
class Playlist(_PlaylistProtocol):
    ...
    media: MediaList
    def __init__(
        self, uri: str | None, stream_info: Mapping[str, Incomplete], media: MediaList, base_uri: str
    ) -> None: ...
...
class SessionData:
    ...
    language: str | None
    def __init__(
        self, data_id: str, value: str | None = None, uri: str | None = None, language: str | None = None
    ) -> None: ...
    def dumps(self) -> str: ...
