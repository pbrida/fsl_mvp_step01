...
class DjangoFilterBackend:
    ...
    def get_filterset(
        self, request: HttpRequest, queryset: QuerySet[Any], view: _APIView
    ) -> filterset.FilterSet | None: ...

    # Any model queryset
    def get_filterset_class(
        self, view: _APIView, queryset: QuerySet[Any] | None = None
    ) -> type[filterset.FilterSet] | None: ...
    ...
    def to_html(
        self, request: HttpRequest, queryset: QuerySet[Any], view: _APIView
    ) -> str: ...  # Renders form for any model
