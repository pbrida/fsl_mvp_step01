...
def SubElement(
    parent: _ElementInterfaceWrapper,
    tag: str,
...
class Writer(writers.Writer[bytes]):
    ...
    def write_zip_str(
        self, zfile: zipfile.ZipFile, name: str, bytes: str | SizedBuffer, compress_type: int = 8
    ) -> None: ...
...
class ODFTranslator(nodes.GenericNodeVisitor):
    ...
    def get_image_width_height(
        self, node: nodes.image, attr: str
    ) -> tuple[float | None, Literal["%", "cm"] | None]: ...
