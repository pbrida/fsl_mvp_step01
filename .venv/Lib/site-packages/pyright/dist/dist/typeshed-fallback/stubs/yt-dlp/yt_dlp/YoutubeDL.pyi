...
class YoutubeDL:
    ...
    def to_screen(
        self, message: str, skip_eol: bool = False, quiet: bool | None = None, only_once: bool = False
    ) -> None: ...
    ...
    def prepare_outtmpl(
        self, outtmpl: str, info_dict: _InfoDict, sanitize: bool = False
    ...
    def run_all_pps(
        self, key: str, info: _InfoDict, *, additional_pps: Collection[PostProcessor] | None = None
    ) -> _InfoDict: ...
    def pre_process(
        self, ie_info: _InfoDict, key: str = "pre_process", files_to_move: Mapping[str, Any] | None = None
    ) -> tuple[_InfoDict, list[str] | None]: ...
    def post_process(
        self, filename: str, info: _InfoDict, files_to_move: Mapping[str, Any] | None = None
    ) -> _InfoDict: ...
    ...
    def list_subtitles(
        self, video_id: str, subtitles: Iterable[Mapping[str, Any]], name: str = "subtitles"
    ) -> None: ...
