...
class Entity:
    ...
    @overload
    def put_http_meta(
        self, key: Literal["url", "method", "user_agent", "client_ip", "x_forwarded_for"], value: str
    ) -> None: ...
    ...
    def put_metadata(
        ...
        key: str,
        value: Any,
        namespace: str = "default",  # value is any object that can be serialized into JSON string
    ) -> None: ...
