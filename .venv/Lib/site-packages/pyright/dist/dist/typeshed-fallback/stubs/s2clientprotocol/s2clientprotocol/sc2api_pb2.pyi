...
class RequestCreateGame(google.protobuf.message.Message):
    ...
    def player_setup(
        self,
    ) -> google.protobuf.internal.containers.RepeatedCompositeFieldContainer[global___PlayerSetup]: ...
    def __init__(
        self,
        *,
...
class ResponseJoinGame(google.protobuf.message.Message):
    ...
    def HasField(
        self,
        field_name: typing.Literal["error", b"error", "error_details", b"error_details", "player_id", b"player_id"],
    ) -> builtins.bool: ...
    def ClearField(
        self,
        field_name: typing.Literal["error", b"error", "error_details", b"error_details", "player_id", b"player_id"],
...
class ResponseRestartGame(google.protobuf.message.Message):
    ...
    def HasField(
        self,
        field_name: typing.Literal[
            "error", b"error", "error_details", b"error_details", "need_hard_reset", b"need_hard_reset"
        ],
    ) -> builtins.bool: ...
    def ClearField(
        self,
...
class ResponseGameInfo(google.protobuf.message.Message):
    ...
    def player_info(
        self,
    ) -> google.protobuf.internal.containers.RepeatedCompositeFieldContainer[global___PlayerInfo]: ...
    @property
...
class RequestObserverAction(google.protobuf.message.Message):
    ...
    def actions(
        self,
    ) -> google.protobuf.internal.containers.RepeatedCompositeFieldContainer[global___ObserverAction]: ...
...
class ResponseReplayInfo(google.protobuf.message.Message):
    ...
    def player_info(
        self,
    ) -> google.protobuf.internal.containers.RepeatedCompositeFieldContainer[global___PlayerInfoExtra]: ...
    def __init__(
        self,
        *,
        map_name: builtins.str | None = ...,
...
class RequestDebug(google.protobuf.message.Message):
    ...
    def __init__(
        self, *, debug: collections.abc.Iterable[s2clientprotocol.debug_pb2.DebugCommand] | None = ...
    ) -> None: ...
...
class PlayerResult(google.protobuf.message.Message):
    ...
    def __init__(
        self, *, player_id: builtins.int | None = ..., result: global___Result.ValueType | None = ...
    ) -> None: ...
