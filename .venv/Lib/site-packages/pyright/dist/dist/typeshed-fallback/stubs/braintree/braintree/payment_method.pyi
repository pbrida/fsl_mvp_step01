...
class PaymentMethod(Resource):
    ...
    def create_signature() -> (
        list[
            ...
            | dict[
                str,
                list[str | dict[str, list[str]] | dict[str, list[str | dict[str, list[str | dict[str, list[str]]]]]]],
            ]
            | dict[str, list[str]]
        ]
    ): ...
    ...
    def signature(
        ...
        | dict[str, list[str | dict[str, list[str]]]]
        | dict[
            str, list[str | dict[str, list[str]] | dict[str, list[str | dict[str, list[str | dict[str, list[str]]]]]]]
        ]
        | dict[str, list[str]]
    ]: ...
    @staticmethod
