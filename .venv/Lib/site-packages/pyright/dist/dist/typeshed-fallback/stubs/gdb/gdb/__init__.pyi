...
class Parameter:
    ...
    def __init__(
        self, name: str, command_class: int, parameter_class: int, enum_sequence: Sequence[str] = ...
    ) -> None: ...
...
class Progspace:
    ...
    frame_filters: dict[str, _FrameFilter]
    frame_unwinders: list[_Unwinder]
    missing_file_handlers: Sequence[
        tuple[Literal["debug"], MissingDebugHandler] | tuple[Literal["file"], MissingFileHandler]
    ]
