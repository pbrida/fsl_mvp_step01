...
class DiGraph(Graph[_Node]):
    ...
    def in_degree(
        self,
    ) -> InDegreeView[_Node] | InMultiDegreeView[_Node]: ...  # Include subtypes' possible return types
    @cached_property
    def out_degree(
        self,
    ) -> OutDegreeView[_Node] | OutMultiDegreeView[_Node]: ...  # Include subtypes' possible return types
