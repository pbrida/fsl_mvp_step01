...
class DebugCommand(google.protobuf.message.Message):
    ...
    def WhichOneof(
        ...
        typing.Literal[
            "draw", "game_state", "create_unit", "kill_unit", "test_process", "score", "end_game", "unit_value"
        ]
        | None
    ): ...
...
class Color(google.protobuf.message.Message):
    ...
    b: builtins.int
    def __init__(
        self, *, r: builtins.int | None = ..., g: builtins.int | None = ..., b: builtins.int | None = ...
    ) -> None: ...
...
class DebugSetUnitValue(google.protobuf.message.Message):
    ...
    class _UnitValueEnumTypeWrapper(
        google.protobuf.internal.enum_type_wrapper._EnumTypeWrapper[DebugSetUnitValue._UnitValue.ValueType],
        builtins.type,
    ):
        DESCRIPTOR: google.protobuf.descriptor.EnumDescriptor
