...
class ChannelzServicer(_channelz_pb2_grpc.ChannelzServicer):
    ...
    @staticmethod
    def GetServers(
        request: _channelz_pb2.GetServersRequest, context: ServicerContext
    ) -> _channelz_pb2.GetServersResponse: ...
    @staticmethod
    def GetServer(
        request: _channelz_pb2.GetServerRequest, context: ServicerContext
    ...
    @staticmethod
    def GetChannel(
        request: _channelz_pb2.GetChannelRequest, context: ServicerContext
    ...
    @staticmethod
    def GetSocket(
        request: _channelz_pb2.GetSocketRequest, context: ServicerContext
