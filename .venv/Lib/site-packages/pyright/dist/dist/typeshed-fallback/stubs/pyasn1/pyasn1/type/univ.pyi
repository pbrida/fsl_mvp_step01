...
class BitString(base.SimpleAsn1Type):
    ...
    @classmethod
    def fromOctetString(
        cls, value, internalFormat: bool = False, prepend: ConvertibleToInt | None = None, padding: int = 0
    ): ...
    def prettyIn(self, value): ...
...
class SequenceOfAndSetOfBase(base.ConstructedAsn1Type):
    ...
    def sort(
        self, key: Callable[[Incomplete], SupportsRichComparison] | None = None, reverse: bool = False
    ) -> None: ...
    def __len__(self) -> int: ...
    def __iter__(self): ...
