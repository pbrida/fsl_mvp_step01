...
class NestedValue(Nested[_T], Convertible[_T, _N]):  # type: ignore[misc]
    ...
    @overload
    def __get__(
        self: NestedValue[_T, Literal[True]], instance: Serialisable | Strict, cls: type | None = None
    ) -> _T | None: ...
    @overload
    def __get__(
        self: NestedValue[_T, Literal[False]], instance: Serialisable | Strict, cls: type | None = None
    ) -> _T: ...
...
class NestedText(NestedValue[_T, _N]):
    ...
    @overload
    def __get__(
        self: NestedText[_T, Literal[True]], instance: Serialisable | Strict, cls: type | None = None
    ) -> _T | None: ...
    @overload
    def __get__(
        self: NestedText[_T, Literal[False]], instance: Serialisable | Strict, cls: type | None = None
    ) -> _T: ...
    # NOTE: It is currently impossible to make a generic based on the parameter type of another generic
    # So we implement explicitly the types used internally
    # str
    ...
    @overload
    def __set__(
        self: NestedText[int, Literal[False]], instance: Serialisable | Strict, value: ConvertibleToInt
    ) -> None: ...
    # If expected type (_T) is not str, it's impossible to use an Element as the value
    @overload
    def __set__(
        self: NestedText[_T, Literal[True]], instance: Serialisable | Strict, value: _HasTagAndGet[Any]
    ) -> NoReturn: ...
    # Anything else
    @overload
    def __set__(
        self: NestedText[_T, Literal[True]], instance: Serialisable | Strict, value: _T | int | Any | None
    ) -> None: ...
...
class NestedFloat(NestedValue[float, _N], Float[_N]):  # type: ignore[misc]
    ...
    @overload
    def __init__(
        self: NestedFloat[Literal[False]], name: str | None = None, *, allow_none: Literal[False] = False
    ) -> None: ...
...
class NestedInteger(NestedValue[int, _N], Integer[_N]):  # type: ignore[misc]
    ...
    @overload
    def __init__(
        self: NestedInteger[Literal[False]], name: str | None = None, *, allow_none: Literal[False] = False
    ) -> None: ...
...
class NestedString(NestedValue[str, _N], String[_N]):  # type: ignore[misc]
    ...
    @overload
    def __init__(
        self: NestedString[Literal[False]], name: str | None = None, *, allow_none: Literal[False] = False
    ) -> None: ...
...
class NestedBool(NestedValue[bool, _N], Bool[_N]):  # type: ignore[misc]
    ...
    @overload
    def __init__(
        self: NestedBool[Literal[False]], name: str | None = None, *, allow_none: Literal[False] = False
    ) -> None: ...
    def __set__(
...
class NestedMinMax(Nested[_M], MinMax[_M, _N]):  # type: ignore[misc]
    ...
    @overload
    def __get__(
        self: NestedMinMax[_M, Literal[True]], instance: Serialisable | Strict, cls: type | None = None
    ) -> _M | None: ...
    @overload
    def __get__(
        self: NestedMinMax[_M, Literal[False]], instance: Serialisable | Strict, cls: type | None = None
    ) -> _M: ...
...
class EmptyTag(Nested[bool], Bool[_N]):  # type: ignore[misc]
    ...
    @overload
    def __init__(
        self: EmptyTag[Literal[False]], name: str | None = None, *, allow_none: Literal[False] = False
    ) -> None: ...
    @overload
    def __get__(
