...
from consolemenu.format import MenuBorderStyle, MenuMargins, MenuPadding
from consolemenu.format import MenuStyle as MenuStyle
...
class MenuPrompt(MenuComponent):
    def __init__(
        self, menu_style: MenuStyle, max_dimension: Dimension | None = None, prompt_string: str = ">>"
    ) -> None: ...
    @property
    def prompt(self) -> str: ...
    @prompt.setter
