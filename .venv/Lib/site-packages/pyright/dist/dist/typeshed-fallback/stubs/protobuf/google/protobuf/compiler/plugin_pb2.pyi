...
class CodeGeneratorRequest(google.protobuf.message.Message):
    ...
    def __init__(
        ...
        *,
        ...
        source_file_descriptors: collections.abc.Iterable[google.protobuf.descriptor_pb2.FileDescriptorProto]
        | None = ...,
...
class CodeGeneratorResponse(google.protobuf.message.Message):
    ...
    class _FeatureEnumTypeWrapper(
        google.protobuf.internal.enum_type_wrapper._EnumTypeWrapper[CodeGeneratorResponse._Feature.ValueType],
        builtins.type,
    ):
