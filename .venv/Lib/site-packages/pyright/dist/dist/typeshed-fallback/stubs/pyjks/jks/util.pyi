...
class AbstractKeystore:
    ...
    @classmethod
    def load(
        cls, filename: FileDescriptorOrPath, store_password: str | None, try_decrypt_keys: bool = True
    ) -> Self: ...
...
class AbstractKeystoreEntry:
    ...
    timestamp: int
    def __init__(
        self, *, store_type: _KeystoreType | None = None, alias: str, timestamp: int, **kwargs: Unused
    ) -> None: ...
    @classmethod
