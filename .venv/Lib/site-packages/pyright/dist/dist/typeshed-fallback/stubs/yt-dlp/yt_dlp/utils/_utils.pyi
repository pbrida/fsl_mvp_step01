...
def xpath_element(
    ...
    name: str | None = None,
    fatal: bool = False,
    default: ET.Element | type[NO_DEFAULT] = ...,
) -> ET.Element | None: ...
def xpath_text(
    node: ET.ElementTree,
    xpath: str,
...
def get_element_html_by_attribute(
    attribute: str, value: str, html: str, *, tag: str, escape_value: bool = True
) -> list[str]: ...
...
def deprecation_warning(
    ...
    *,
    ...
    stacklevel: int = 0,
    **kwargs: Any,  # kwargs are passed to printer.
) -> None: ...
...
def detect_exe_version(
    output: str, version_re: str | Pattern[str] | None = None, unrecognized: str = "present"
) -> str: ...
def get_exe_version(
    exe: str,
...
def try_get(
    src: Any, getter: Callable[..., _T] | Collection[Callable[..., _T]], expected_type: type[_T] | None = None
) -> _T: ...
...
def cli_configuration_args(
    argdict: dict[str, Any], keys: Iterable[str], default: Any = ..., use_compat: bool = True
) -> Any: ...
...
def jwt_encode_hs256(
    payload_data: Any, key: str, headers: Mapping[str, Any] = ...
) -> bytes: ...  # Passed to json.dumps().
...
class Config:
    ...
    def parse_known_args(
        self, *, values: optparse.Values | None = None, strict: bool = True
...
class RetryManager:
    ...
    def __init__(
        self,
        _retries: int | None,
        _error_callback: Callable[..., Any],
        **kwargs: Any,  # kwargs passed to _error_callback.
    ) -> None: ...
    @property
    def error(self) -> None: ...
    @error.setter
