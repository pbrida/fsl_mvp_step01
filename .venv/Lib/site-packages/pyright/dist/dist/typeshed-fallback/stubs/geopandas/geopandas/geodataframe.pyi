...
class GeoDataFrame(GeoPandasBase, pd.DataFrame):  # type: ignore[misc]
    ...
    @overload
    def set_crs(
        self, crs: _ConvertibleToCRS | None, epsg: int, inplace: bool = False, allow_override: bool = False
    ) -> Self: ...
    @overload
    ...
    def explode(
        self, column: IndexLabel | None = None, ignore_index: bool = False, index_parts: bool = False
    ) -> Self: ...
    def to_postgis(
        self,
        name: str,
