...
from .timezone import tzid_from_dt as tzid_from_dt
from .timezone import tzid_from_tzinfo as tzid_from_tzinfo
...
class vText(str):
    ...
    params: Parameters
    def __new__(
        cls, value: ICAL_TYPE, encoding: str = "utf-8", params: SupportsKeysAndGetItem[str, str] = {}
    ) -> Self: ...
    def to_ical(self) -> bytes: ...
    @classmethod
