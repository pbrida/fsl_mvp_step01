...
class CargoPanel(google.protobuf.message.Message):
    ...
    def ClearField(
        self,
        field_name: typing.Literal["passengers", b"passengers", "slots_available", b"slots_available", "unit", b"unit"],
    ) -> None: ...
...
class ProductionPanel(google.protobuf.message.Message):
    ...
    def production_queue(
        self,
    ) -> google.protobuf.internal.containers.RepeatedCompositeFieldContainer[global___BuildItem]: ...
    def __init__(
        self,
        *,
        unit: global___UnitInfo | None = ...,
...
class ActionSelectIdleWorker(google.protobuf.message.Message):
    ...
    class _TypeEnumTypeWrapper(
        google.protobuf.internal.enum_type_wrapper._EnumTypeWrapper[ActionSelectIdleWorker._Type.ValueType],
        builtins.type,
    ):
        DESCRIPTOR: google.protobuf.descriptor.EnumDescriptor
