...
def get_all_model_fields(
    model: type[Model],
) -> dict[str, models.Field[Any, Any]]: ...  # Fields vary by model definition
def get_model_field(
    model: type[Model], field_name: str
) -> models.Field[Any, Any]: ...  # Field type unknown at static time
def get_field_parts(
    model: type[Model], field_name: str
) -> list[models.Field[Any, Any]]: ...  # Relationship fields vary
def resolve_field(
