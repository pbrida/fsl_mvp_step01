...
from .fonts import CoreFont, FontFace, TextStyle, TTFFont
from .fonts import TitleStyle as TitleStyle
...
class FPDF(GraphicsStateMixin):
    ...
    def set_link(
        self, link, y: float = 0, x: float = 0, page: int = -1, zoom: float | Literal["null"] = "null"
    ) -> None: ...
    def link(
        self,
        x: float,
