...
def parse_uri(
    uri: str,
) -> tuple[str | MaybeNone, str | MaybeNone, str | MaybeNone, str | MaybeNone, str | MaybeNone]: ...
...
def proxy_info_from_url(
    url: str, method: Literal["http", "https"] = "http", noproxy: str | None = None
) -> ProxyInfo: ...
