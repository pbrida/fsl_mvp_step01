...
class Address(message.Message, metaclass=MessageMeta):
    ...
    class OtherAddress(message.Message, metaclass=MessageMeta):
        ...
        value: any_pb2.Any
        def __init__(
            self, name: str | None = ..., value: any_pb2.Any | Mapping[Incomplete, Incomplete] | None = ...
        ) -> None: ...
...
class GetTopChannelsResponse(message.Message, metaclass=MessageMeta):
    ...
    def __init__(
        self, channel: Iterable[Channel | Mapping[Incomplete, Incomplete]] | None = ..., end: bool = ...
    ) -> None: ...
    DESCRIPTOR: Descriptor
...
class GetServersResponse(message.Message, metaclass=MessageMeta):
    ...
    def __init__(
        self, server: Iterable[Server | Mapping[Incomplete, Incomplete]] | None = ..., end: bool = ...
    ) -> None: ...
    DESCRIPTOR: Descriptor
...
class GetServerSocketsRequest(message.Message, metaclass=MessageMeta):
    ...
    max_results: int
    def __init__(
        self, server_id: int | None = ..., start_socket_id: int | None = ..., max_results: int | None = ...
    ) -> None: ...
    DESCRIPTOR: Descriptor
