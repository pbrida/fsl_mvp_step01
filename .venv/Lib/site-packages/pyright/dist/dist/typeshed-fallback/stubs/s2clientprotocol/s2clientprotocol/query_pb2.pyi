...
class RequestQuery(google.protobuf.message.Message):
    ...
    def pathing(
        self,
    ) -> google.protobuf.internal.containers.RepeatedCompositeFieldContainer[global___RequestQueryPathing]: ...
    @property
    def abilities(
        self,
...
class ResponseQuery(google.protobuf.message.Message):
    ...
    def pathing(
        self,
    ) -> google.protobuf.internal.containers.RepeatedCompositeFieldContainer[global___ResponseQueryPathing]: ...
    @property
    def abilities(
        self,
    ) -> google.protobuf.internal.containers.RepeatedCompositeFieldContainer[
...
class RequestQueryPathing(google.protobuf.message.Message):
    ...
    def HasField(
        self,
        field_name: typing.Literal[
            "end_pos", b"end_pos", "start", b"start", "start_pos", b"start_pos", "unit_tag", b"unit_tag"
        ],
    ) -> builtins.bool: ...
    def ClearField(
        self,
...
class ResponseQueryAvailableAbilities(google.protobuf.message.Message):
    ...
    def ClearField(
        self,
        field_name: typing.Literal["abilities", b"abilities", "unit_tag", b"unit_tag", "unit_type_id", b"unit_type_id"],
    ) -> None: ...
