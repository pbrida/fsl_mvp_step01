...
class PyCDC:
    ...
    def Draw3dRect(
        self, rect: tuple[Incomplete, Incomplete, Incomplete, Incomplete], colorTopLeft, colorBotRight, /
    ) -> None: ...
...
class PyCToolBar:
    ...
    def SetSizes(
        self, sizeButton: tuple[Incomplete, Incomplete], sizeButton1: tuple[Incomplete, Incomplete], /
    ) -> None: ...
...
class PyCView:
    def CreateWindow(
        self, parent: PyCWnd, arg, arg1, arg2: tuple[Incomplete, Incomplete, Incomplete, Incomplete], /
    ) -> None: ...
    def GetDocument(self) -> PyCDocument: ...
...
class EXTENSION_CONTROL_BLOCK:
    ...
    def TransmitFile(
        self, callback, param, hFile, statusCode: str, BytesToWrite, Offset, head: str, tail: str, flags, /
    ): ...
