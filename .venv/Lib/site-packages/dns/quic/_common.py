...
class BaseQuicStream:
    ...
    def _common_add_input(self, data, is_end):
        ...
        try:
            return (self._expecting > 0 and self._buffer.have(self._expecting)) or self._buffer.seen_end
    ...
    def __init__(self, conf, verify_mode, connection_factory, server_name=None, h3=False):
        ...
        if conf is None:
            ...
            if verify_path is not None:
                cafile, capath = dns._tls_util.convert_verify_to_cafile_and_capath(verify_path)
