...
if dns._features.have("doh"):
    ...
    class _NetworkBackend(_CoreAsyncNetworkBackend):
        ...
        async def connect_tcp(self, host, port, timeout=None, local_address=None, socket_options=None):  # pylint: disable=signature-differs
            addresses = []
...
class Backend(dns._asyncbackend.Backend):
    ...
    async def make_socket(
        ...
        raise NotImplementedError("unsupported socket " + f"type {socktype}")  # pragma: no cover
