...
class Name:
    ...
    def to_unicode(self, omit_final_dot: bool = False, idna_codec: IDNACodec | None = None) -> str:
...
def from_unicode(text: str, origin: Name | None = root, idna_codec: IDNACodec | None = None) -> Name:
