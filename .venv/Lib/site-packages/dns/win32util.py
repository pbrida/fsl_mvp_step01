                    ...
                    for interface in system.Win32_NetworkAdapterConfiguration():
                        if interface.IPEnabled and interface.DNSServerSearchOrder:
                            ...
                            if interface.DNSDomainSuffixSearchOrder:
                                self.info.search = [_config_domain(x) for x in interface.DNSDomainSuffixSearchOrder]
                            break
                finally:
        ...
        def _is_nic_enabled(self, lm, guid):
            ...
            try:
                ...
                try:
                    ...
                    device_key = winreg.OpenKey(lm, rf"SYSTEM\CurrentControlSet\Enum\{pnp_id}")
    ...
    class _Win32Getter(_RegistryGetter):
        def get(self):
            ...
            def format_ipv6(sockaddr_in6):
                ...
                parts = [sockaddr_in6.sa_data[i + 6] << 8 | sockaddr_in6.sa_data[i + 6 + 1] for i in range(0, 16, 2)]
