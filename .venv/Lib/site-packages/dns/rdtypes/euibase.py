...
class EUIBase(dns.rdata.Rdata):
    ...
    def __init__(self, rdclass, rdtype, eui):
        ...
        if len(self.eui) != self.byte_len:
            raise dns.exception.FormError(f"EUI{self.byte_len * 8} rdata has to have {self.byte_len} bytes")
    ...
    def from_text(cls, rdclass, rdtype, tok, origin=None, relativize=True, relativize_to=None):
        ...
        if len(text) != cls.text_len:
            raise dns.exception.SyntaxError(f"Input text must have {cls.text_len} characters")
