...
class TextInputHandler:
    ...
    def _insert_char(self, char: str) -> None:
        self.text = self.text[: self._cursor_index] + char + self.text[self._cursor_index :]
    ...
    def _delete_char(self) -> None:
        ...
        self.text = self.text[: self._cursor_index - 1] + self.text[self._cursor_index :]
        self._cursor_index -= 1
    ...
    def _delete_forward(self) -> None:
        ...
        self.text = self.text[: self._cursor_index] + self.text[self._cursor_index + 1 :]

    def handle_key(self, key: str) -> None:
        # Handle backspace (both possible codes)
        if key == self.BACKSPACE_KEY or (self.ALT_BACKSPACE and key == self.ALT_BACKSPACE):
            self._delete_char()
        # Handle delete key
