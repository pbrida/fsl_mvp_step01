...
class RichToolkit:
    ...
    def __exit__(self, exc_type: Any, exc_value: Any, traceback: Any) -> Union[bool, None]:
    ...
    def print(self, *renderables: RenderableType, **metadata: Any) -> None:
        self.console.print(*[self.style.render_element(renderable, **metadata) for renderable in renderables])
