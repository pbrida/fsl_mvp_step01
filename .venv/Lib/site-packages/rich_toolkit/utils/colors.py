...
def fade_color(color: Color, background_color: Color, brightness_multiplier: float) -> Color:
    """
...
def _get_terminal_color(color_type: Literal["text", "background"], default_color: str) -> str:
    import os
    import re
    import select
    import sys
    ...
    signal.signal(signal.SIGTERM, lambda signum, frame: (restore_terminal(), sys.exit(0)))
