...
class TemplateLookup(TemplateCollection):
    ...
    def get_template(self, uri):
        ...
        try:
            ...
            for dir_ in self.directories:
                ...
                raise exceptions.TopLevelLookupException("Can't locate template for uri %r" % uri) from e
    ...
    def _check(self, uri, template):
        ...
        try:
            ...
            self._collection.pop(uri, None)
            raise exceptions.TemplateLookupException("Can't locate template for uri %r" % uri) from e
