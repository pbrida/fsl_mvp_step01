...
from mako import exceptions, parsetree
...
class Lexer:
    ...
    def append_node(self, nodecls, *args, **kwargs):
        ...
        if self.control_line:
            ...
            if (
                not (isinstance(node, parsetree.ControlLine) and control_frame.is_ternary(node.keyword))
    ...
    def parse(self):
        self.encoding, self.text = self.decode_raw_stream(self.text, True, self.encoding, self.filename)
