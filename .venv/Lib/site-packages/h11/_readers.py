...
class ContentLengthReader:
    ...
    def read_eof(self) -> NoReturn:
        raise RemoteProtocolError(
            "peer closed connection without sending complete message body " "(received {} bytes, expected {})".format(
    ...
    def __call__(self, buf: ReceiveBuffer) -> Union[Data, EndOfMessage, None]:
        ...
        if self._bytes_to_discard:
            ...
            if data != self._bytes_to_discard[: len(data)]:
                raise LocalProtocolError(f"malformed chunk footer: {data!r} (expected {self._bytes_to_discard!r})")
