...
class Dialect(EventTarget):
    ...
    def get_table_names(self, connection: Connection, schema: Optional[str] = None, **kw: Any) -> List[str]:
    ...
    def get_temp_table_names(self, connection: Connection, schema: Optional[str] = None, **kw: Any) -> List[str]:
    ...
    def get_temp_view_names(self, connection: Connection, schema: Optional[str] = None, **kw: Any) -> List[str]:
    ...
    def _assert_and_set_isolation_level(self, dbapi_conn: DBAPIConnection, level: IsolationLevel) -> None:
        raise NotImplementedError()
