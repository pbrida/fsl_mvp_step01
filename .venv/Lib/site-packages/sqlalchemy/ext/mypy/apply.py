...
from mypy.types import AnyType, Instance, NoneTyp, ProperType, TypeOfAny, UnboundType, UnionType, get_proper_type
...
def apply_type_to_mapped_statement(
    ...
    if left_hand_explicit_type is not None:
        ...
        left_node.type = api.named_type(
            ...
            ([AnyType(TypeOfAny.special_form)] if python_type_for_type is None else [python_type_for_type]),
        )
