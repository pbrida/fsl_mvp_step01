...
from typing import TYPE_CHECKING, AbstractSet, Any, Dict, Iterable, List, Optional, Set, Tuple, TypeVar, Union, overload
from weakref import WeakKeyDictionary

from .. import event, inspect, types, util
from ..orm import Mapper
from ..orm._typing import _O, _T, _ExternalEntityType
from ..orm.attributes import AttributeEventToken, InstrumentedAttribute, QueryableAttribute, flag_modified
