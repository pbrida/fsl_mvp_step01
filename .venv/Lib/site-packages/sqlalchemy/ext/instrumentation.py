...
orm_instrumentation._instrumentation_factory = _instrumentation_factory = ExtendedInstrumentationRegistry()
...
def _install_lookups(lookups):
    ...
    orm_base.opt_manager_of_class = orm_util.opt_manager_of_class = attributes.opt_manager_of_class = (
        orm_instrumentation.opt_manager_of_class
