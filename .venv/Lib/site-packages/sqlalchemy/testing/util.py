...
from ..schema import Column, DropConstraint, DropTable, ForeignKeyConstraint, MetaData, Table
...
def round_decimal(value, prec):
    ...
    return (value * decimal.Decimal("1" + "0" * prec)).to_integral(decimal.ROUND_FLOOR) / pow(10, prec)
