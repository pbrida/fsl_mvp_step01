...
class TrueDivTest(fixtures.TestBase):
    ...
    def test_truediv_integer(self, connection, left, right, expected):
        ...
        eq_(
            connection.scalar(select(literal_column(left, type_=Integer()) / literal_column(right, type_=Integer()))),
            expected,
        )
    ...
    def test_truediv_numeric(self, connection, left, right, expected):
        ...
        eq_(
            connection.scalar(
                select(literal_column(left, type_=Numeric(10, 2)) / literal_column(right, type_=Numeric(10, 2)))
            ),
    ...
    def test_truediv_float(self, connection, left, right, expected):
        ...
        eq_(
            connection.scalar(select(literal_column(left, type_=Float()) / literal_column(right, type_=Float()))),
            expected,
        )
    ...
    def test_floordiv_numeric(self, connection, left, right, expected):
        ...
        eq_(
            connection.scalar(select(literal_column(left, type_=Numeric()) // literal_column(right, type_=Numeric()))),
            decimal.Decimal(expected),
        )
