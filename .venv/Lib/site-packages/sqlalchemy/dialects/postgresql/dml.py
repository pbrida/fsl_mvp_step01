...
class Insert(StandardInsert):
    ...
    _on_conflict_exclusive = _exclusive_against(
        "_post_values_clause",
        msgs={"_post_values_clause": "This Insert construct already has " "an ON CONFLICT clause established"},
    )
    ...
    def on_conflict_do_update(
        ...
        """
        self._post_values_clause = OnConflictDoUpdate(constraint, index_elements, index_where, set_, where)
        return self
...
class OnConflictDoUpdate(OnConflictClause):
    ...
    def __init__(
        ...
        self.update_values_to_set = [(coercions.expect(roles.DMLColumnRole, key), value) for key, value in set_.items()]
