...
from typing import TYPE_CHECKING, Any, Iterable, Iterator, List, Optional, Tuple, Type, TypeVar, Union

from .. import util
from ..engine import result
from . import attributes, relationships
from . import exc as orm_exc
from . import util as orm_util
from .base import PassiveFlag
from .query import Query
from .session import object_session
from .writeonly import AbstractCollectionWriter, WriteOnlyAttributeImpl, WriteOnlyHistory, WriteOnlyLoader
        ...
        if sess is None:
            ...
            if sess is None:
                raise orm_exc.DetachedInstanceError(
                    ...
                    "of attribute '%s' cannot proceed" % (orm_util.instance_str(instance), self.attr.key)
                )
