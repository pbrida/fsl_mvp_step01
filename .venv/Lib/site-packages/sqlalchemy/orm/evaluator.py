...
class _EvaluatorCompiler:
    ...
    def visit_column(self, clause):
        ...
        if self.target_cls and not issubclass(self.target_cls, parentmapper.class_):
            raise UnevaluatableError("Can't evaluate criteria against " f"alternate class {parentmapper.class_}")
    ...
    def visit_binary(self, clause):
        ...
        if meth:
            ...
            raise UnevaluatableError(f"Cannot evaluate {type(clause).__name__} with " f"operator {clause.operator}")
    ...
    def visit_unary(self, clause):
        ...
        if clause.operator is operators.inv:
            ...
            return evaluate
        raise UnevaluatableError(f"Cannot evaluate {type(clause).__name__} " f"with operator {clause.operator}")
