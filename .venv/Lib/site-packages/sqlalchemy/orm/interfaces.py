...
from .. import ColumnElement, inspection, util
...
if typing.TYPE_CHECKING:
    ...
    from ..sql._typing import _ColumnExpressionArgument, _ColumnsClauseArgument, _DMLColumnArgument, _InfoType
...
class StrategizedProperty(MapperProperty[_T]):
    ...
    _all_strategies: collections.defaultdict[Type[MapperProperty[Any]], Dict[_StrategyKey, Type[LoaderStrategy]]] = (
