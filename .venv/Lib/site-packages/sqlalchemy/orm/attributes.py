...
from . import collections, interfaces
...
if TYPE_CHECKING:
    ...
    from ..sql._typing import _ColumnExpressionArgument, _DMLColumnArgument, _InfoType, _PropagateAttrsType
    from ..sql.annotation import _AnnotationDict
    from ..sql.elements import ColumnElement, Label
    from ..sql.operators import OperatorType
    from ..sql.selectable import FromClause
    from ._typing import _O, _EntityType, _ExternalEntityType, _InstanceDict, _InternalEntityType, _LoaderCallable
            ...
            try:
                ...
                try:
                    ...
                    raise AttributeError(
                        ...
                        "object associated with %s has an attribute %r" % (type(descriptor).__name__, self, attribute)
                    ) from err2
                else:
                    try:
            ...
            if key not in state.committed_state or state.committed_state[key] is NO_VALUE:
                ...
                if value is PASSIVE_NO_RESULT or value is NO_VALUE:
                    ...
                    try:
                        ...
                        raise KeyError(
                            "Deferred loader for attribute " "%r failed to populate " "correctly" % key
                        ) from err
        ...
        if not self._deferred_history:
            ...
            if original is PASSIVE_NO_RESULT:
                loader_passive = passive | (
                    PASSIVE_ONLY_PERSISTENT | NO_AUTOFLUSH | LOAD_AGAINST_COMMITTED | NO_RAISE | DEFERRED_HISTORY_LOAD
                )
...
def register_attribute(
    ...
    **kw: Any,
    ...
    desc = register_descriptor(class_, key, comparator=comparator, parententity=parententity, doc=doc)
...
def register_attribute_impl(
    ...
    **kw: Any,
    ...
    if impl_class:
        ...
        impl = CollectionAttributeImpl(class_, key, callable_, dispatch, typecallable=typecallable, **kw)
    elif useobject:
...
def register_descriptor(
    ...
    *,
    ...
    descriptor = InstrumentedAttribute(class_, key, comparator=comparator, parententity=parententity)
...
def init_state_collection(state: InstanceState[Any], dict_: _InstanceDict, key: str) -> CollectionAdapter:
    ...
    adapter: CollectionAdapter = attr.get_collection(state, dict_, user_data, passive=PassiveFlag.PASSIVE_NO_FETCH)
