...
import typing
from typing import TYPE_CHECKING, Any, Callable, Collection, Iterable, NoReturn, Optional, Type, Union, overload
...
if TYPE_CHECKING:
    ...
    from ..sql.schema import FetchedValue, _ServerDefaultArgument
