...
from ..sql import Select, coercions, expression, roles, visitors
...
if TYPE_CHECKING:
    ...
    from ._typing import SynchronizeSessionArgument, _EntityType, _ExternalEntityType, _InternalEntityType
    ...
    def with_parent(
        ...
        if property is None:
            ...
            for prop in mapper.iterate_properties:
                if (
                    isinstance(prop, relationships.RelationshipProperty) and prop.mapper is entity_zero.mapper  # type: ignore
                ):
