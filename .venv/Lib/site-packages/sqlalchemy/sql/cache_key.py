...
from .visitors import HasTraversalDispatch, HasTraverseInternals, InternalTraversal, anon_map, prefix_anon_map
    ...
    def _generate_cache_attrs(
        ...
        if inherit:
            ...
            assert _cache_key_traversal is not NO_CACHE, (
                f"class {cls} has _cache_key_traversal=NO_CACHE, " "which conflicts with inherit_cache=True"
            )
...
class _CacheKeyTraversal(HasTraversalDispatch):
    ...
    def visit_multi_list(
        ...
        return (
            attrname,
            tuple(
                (elem._gen_cache_key(anon_map, bindparams) if isinstance(elem, HasCacheKey) else elem) for elem in obj
            ),
        )
    ...
    def visit_has_cache_key_tuples(
        ...
        return (
            attrname,
            tuple(tuple(elem._gen_cache_key(anon_map, bindparams) for elem in tup_elem) for tup_elem in obj),
        )
    ...
    def visit_executable_options(
        ...
        return (
            attrname,
            tuple(elem._gen_cache_key(anon_map, bindparams) for elem in obj if elem._is_has_cache_key),
        )
    ...
    def visit_prefix_sequence(
        ...
        return (
            attrname,
            tuple([(clause._gen_cache_key(anon_map, bindparams), strval) for clause, strval in obj]),
        )
    ...
    def visit_string_multi_dict(
        ...
        return (
            ...
            tuple(
                (
                    key,
                    (value._gen_cache_key(anon_map, bindparams) if isinstance(value, HasCacheKey) else value),
                )
    ...
    def visit_dml_ordered_values(
        ...
        return (
            ...
            tuple(
                (
                    (key._gen_cache_key(anon_map, bindparams) if hasattr(key, "__clause_element__") else key),
    ...
    def visit_dml_values(
        ...
        return (
            ...
            tuple(
                (
                    (k._gen_cache_key(anon_map, bindparams) if hasattr(k, "__clause_element__") else k),
