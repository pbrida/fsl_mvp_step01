...
from typing import TYPE_CHECKING, Any, Callable, List, MutableMapping, Optional, Tuple, Type, TypeVar, Union, cast
    ...
    def _retrieve_tracker_rec(self, fn, apply_propagate_attrs, opts):
        ...
        if rec is None:
            ...
            bindparams[:] = [
                ...
                for orig_bind, new_bind in zip(rec.closure_bindparams, bindparams, strict=False)
            ]
...
class AnalyzedCode:
    ...
    def _init_closure(self, fn):
        ...
        for closure_index, (fv, cell) in enumerate(zip(fn.__code__.co_freevars, closure, strict=False)):
...
class AnalyzedFunction:
    ...
    def _instrument_and_run_function(self, lambda_element):
        ...
        if not build_py_wrappers:
            ...
            if closure:
                new_closure = {
                    fv: cell.cell_contents for fv, cell in zip(fn.__code__.co_freevars, closure, strict=False)
                }
            else:
                new_closure = {}
