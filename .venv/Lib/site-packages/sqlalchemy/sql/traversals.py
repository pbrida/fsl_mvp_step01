...
class TraversalComparatorStrategy(HasTraversalDispatch, util.MemoizedSlots):
        ...
        while stack:
            ...
            for (
                ...
                assert dispatch is not None, (
                    f"{self.__class__} has no dispatch for " f"'{self._dispatch_lookup[left_visit_sym]}'"
                )
    ...
    def visit_anon_name(self, attrname, left_parent, left, right_parent, right, **kw):
        return _resolve_name_for_compare(left_parent, left, self.anon_map[0], **kw) == _resolve_name_for_compare(
