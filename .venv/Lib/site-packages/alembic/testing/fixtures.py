...
from sqlalchemy import Column, MetaData, String, Table, create_mock_engine, inspect, testing, text
...
class TestBase(SQLAlchemyTestBase):
    ...
    def as_sql_migration_context(self, connection):
        return MigrationContext.configure(connection, opts=dict(transaction_per_migration=True, as_sql=True))
...
class AlterColRoundTripFixture:
    ...
    def _compare_server_default(self, t1, s1, t2, s2):
        ...
        assert not self.ctx.impl.compare_server_default(c1, c2, s2, s1), (
