...
def create_exclude_constraint(constraint_name: str, table_name: str, *elements: Any, **kw: Any) -> Optional[Table]:
...
def inline_literal(value: Union[str, int], type_: Optional[TypeEngine[Any]] = None) -> _literal_bindparam:
...
def register_operation(name: str, sourcename: Optional[str] = None) -> Callable[[Type[_T]], Type[_T]]:
