...
def begin_transaction() -> Union[_ProxyTransaction, ContextManager[None, Optional[bool]]]:
...
def configure(
    ...
    render_item: Optional[Callable[[str, Any, AutogenContext], Union[str, Literal[False]]]] = None,
