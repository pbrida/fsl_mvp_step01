...
from sqlalchemy import Column, MetaData, PrimaryKeyConstraint, String, Table, cast, schema, text
...
class DefaultImpl(metaclass=ImplMeta):
    ...
    def _exec(
        ...
        if self.as_sql:
            ...
            self.static_output(str(compiled).replace("\t", "    ").strip() + self.command_terminator)
            return None
        else:
    ...
    def _create_metadata_constraint_sig(self, constraint: _autogen._C, **opts: Any) -> _constraint_sig[_autogen._C]:
