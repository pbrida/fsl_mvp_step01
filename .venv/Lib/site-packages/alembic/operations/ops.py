...
class CreateCheckConstraintOp(AddConstraintOp):
    ...
    def to_constraint(self, migration_context: Optional[MigrationContext] = None) -> CheckConstraint:
        schema_obj = schemaobj.SchemaObjects(migration_context)
...
class DropColumnOp(AlterTableOp):
    ...
    def reverse(self) -> AddColumnOp:
        ...
        op = AddColumnOp.from_column_and_tablename(self.schema, self.table_name, self._reverse.column)
