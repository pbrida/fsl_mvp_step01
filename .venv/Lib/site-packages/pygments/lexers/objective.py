...
from pygments.lexer import RegexLexer, bygroups, default, include, inherit, this, using, words
...
def objective(baselexer):
    ...
    class GeneratedObjectiveCVariant(baselexer):
        ...
        def get_tokens_unprocessed(self, text, stack=("root",)):
            from pygments.lexers._cocoa_builtins import COCOA_INTERFACES, COCOA_PRIMITIVES, COCOA_PROTOCOLS
