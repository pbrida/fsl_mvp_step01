...
from pygments.lexer import Lexer, RegexLexer, bygroups, default, do_insertions, include, line_re, words
from pygments.token import Comment, Generic, Keyword, Name, Number, Operator, Punctuation, String, Whitespace
