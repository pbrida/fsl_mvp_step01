...
from pygments.token import Comment, Error, Keyword, Name, String, Whitespace, string_to_tokentype
from pygments.util import ClassNotFound, OptionError, get_bool_opt, get_choice_opt, get_int_opt, get_list_opt
