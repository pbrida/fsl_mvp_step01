...
for s in t1_syms: post("/draft/pick", {"team_id": t1, "symbol": s})
for s in t2_syms: post("/draft/pick", {"team_id": t2, "symbol": s})
...
print("=== 5) buckets ===")
map1 = {
    "AAPL":"TECH","MSFT":"MID_CAP","VTI":"ETF","KO":"DIVIDEND",
    "NVDA":"WILDCARD","SHEL":"INTERNATIONAL","SHOP":"SMALL_CAP","TSLA":"LARGE_CAP"
}
map2 = {
    "GOOGL":"TECH","AMZN":"MID_CAP","VOO":"ETF","PG":"DIVIDEND",
    "META":"WILDCARD","BABA":"INTERNATIONAL","ADBE":"SMALL_CAP","NFLX":"LARGE_CAP"
}
chosen1 = []
